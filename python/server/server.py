...
@uamethod
def move_servo1(parent, angle):
    #move servo
	var_Servo1_angle.set_value(angle)
...
if __name__ == "__main__":
    ...
    #myobj = objects.add_object(idx, "RobotArm")
    var_Servo1_angle = myobj.add_variable(idx, "Servo1_angle", 6)
    var_Servo1_angle.set_writable()    # Set MyVariable to be writable by clients
    ...
    multiply_node = myobj.add_method(idx, "move_servo1", move_servo1, [ua.VariantType.Int64])
